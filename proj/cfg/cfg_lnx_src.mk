...
KODE_CPU_SRC_S := cpu_head_s.gas cpu_gate_s.gas
KODE_CPU_SRC_C := cpu_head_c.c   cpu_gate_c.c \
                  cpu_hd.c \
                  cpu_ps2.c \
                  cpu_disp_text.c \
                  cpu_disp_8bit.c \
...
KODE_STARTUP_OBJ := $(patsubst %.c,   $(BUILD_ROOT)/$(KODE_ROOT)/$(KODE_STARTUP_DIR)/%.o, $(KODE_STARTUP_SRC_C))
...
INC_DIR += -I$(SRC_ROOT)/$(KODE_ROOT) \
           ...
           -I$(SRC_ROOT)/$(KODE_ROOT)/$(KODE_CPU_DIR)/$(KODE_CPU_LNX_DIR) \
