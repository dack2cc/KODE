...
)
{
    ...
    for (i = 0; i < 16; ++i) {
        ...
        if (0 != (uiFont & 0x80)) {
            pbyVRAM[0] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x40)) {
            pbyVRAM[1] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x20)) {
            pbyVRAM[2] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x10)) {
            pbyVRAM[3] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x08)) {
            pbyVRAM[4] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x04)) {
            pbyVRAM[5] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x02)) {
            pbyVRAM[6] = uiColorIdx_in;
        }

        if (0 != (uiFont & 0x01)) {
            pbyVRAM[7] = uiColorIdx_in;
        }
    }
}
